...
public:
  ...
  /**
   * Checks the spelling of all the words in the contents of the class and
   * returns a list of words with incorrect spelling.
   ...
   */
  bool buildDictionary(string fileName);
  ...
  /**
   * Gets the dictionary as a vector.
   */
